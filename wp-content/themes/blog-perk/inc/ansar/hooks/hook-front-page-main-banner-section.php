<?php
if (!function_exists('blog_perk_front_page_banner_section')) :
    /**
     *
     * @since Blog Perk
     *
     */
    function blog_perk_front_page_banner_section()
    {
        if (is_front_page() || is_home()) {
        $fameup_enable_main_slider = fameup_get_option('blog_perk_slider_main_news_section');
...
add_action('blog_perk_action_front_page_main_section_1', 'blog_perk_front_page_banner_section', 40);